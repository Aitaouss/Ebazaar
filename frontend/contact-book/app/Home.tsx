...
export default function App() {
  ...
  return (
    <div className="reltive h-screen w-full px-6 sm:px-10 lg:px-20 bg-overlay flex flex-col">
        ...
        {sizeLg > 1024 ? (
          ...
          <div className="w-full text-center">
            ...
            <div className="flex items-center gap-4 mt-6 justify-center">
              <button
                className="transition-all  duration-300 bg-[#015B46] text-white px-10 sm:px-12 py-3 sm:py-4 cursor-pointer font-semibold text-[0.8rem] sm:text-sm rounded shadow-sm hover:bg-[#014b3c] mt-4"
                onClick={() => setCheck("register")}
              >
                Get Started
              </button>
              <button
                className="transition-all duration-300 bg-white text-[#015B46] px-10 sm:px-12 py-3 sm:py-4 border border-gray-200 cursor-pointer font-semibold text-[0.8rem] sm:text-sm rounded shadow-sm hover:bg-[#f1f1f1] mt-4"
                onClick={() => setCheck("register")}
              >
                Explore Categorie
              </button>
